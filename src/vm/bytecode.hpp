...
instructions{
  ...
  std::tuple{"load-character", opcode::load_character, std::size_t{2}},
  ...
  std::tuple{"truncate-quotient", opcode::truncate_quotient, std::size_t{3}},
  std::tuple{"truncate-remainder", opcode::truncate_remainder, std::size_t{3}},
  ...
  std::tuple{"char=?", opcode::char_eq, std::size_t{3}},
  std::tuple{"char<?", opcode::char_lt, std::size_t{3}},
  std::tuple{"char<=?", opcode::char_le, std::size_t{3}},
  std::tuple{"char>?", opcode::char_gt, std::size_t{3}},
  std::tuple{"char>=?", opcode::char_ge, std::size_t{3}},
  ...
  std::tuple{"call/keywords", opcode::call_keywords, std::size_t{3}},
  std::tuple{"tail-call/keywords", opcode::tail_call_keywords, std::size_t{2}},
  ...
  std::tuple{"string-cursor-start", opcode::string_cursor_start, std::size_t{2}},
  std::tuple{"string-cursor-end", opcode::string_cursor_end, std::size_t{2}},
  std::tuple{"string-cursor-next", opcode::string_cursor_next, std::size_t{2}},
  std::tuple{"string-cursor-prev", opcode::string_cursor_prev, std::size_t{2}},
